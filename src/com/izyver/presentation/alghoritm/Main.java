...
import com.izyver.presentation.alghoritm.creator.LittleRelatedTagsCreator;
import com.izyver.presentation.alghoritm.creator.PrimAlghoritmCreator;
...
public class Main {
    ...
    static String landscapes = "/Users/izyver/Projects/PresentationsAlghoritm/qualification_round_2019.in/b_lovely_landscapes.txt";

    public static void main(String[] args) {
        SlideshowGenerator generator = new SlideshowGenerator();
        generator.setCreator(new PrimAlghoritmCreator());
        generator.createSlideshow(moments);
